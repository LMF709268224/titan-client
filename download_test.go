...
func TestTitanDownloader_Download(t *testing.T) {
	carfiles := []string{
		...
		"QmR7SxcCd6EkNQy5x25AbTsjBYrUmB7YtzpVkm9iVTufEz",
	}
	...
	downloader := NewDownloader(WithCustomGatewayAddressOption("http://127.0.0.1:5001"), WithLocatorAddressOption("http://192.168.0.132:5000")) //http://39.108.143.56:5000
	// for {
